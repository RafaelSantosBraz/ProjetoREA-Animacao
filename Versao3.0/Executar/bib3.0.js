        ...
        case 1:
            {
                switch (prencherquad) {
                    case 1: //preenche o primeio quadrado - 1cm²
                        ...
                        audio.src = "/Versao3.0/Audios/Fala 3.m4a";
                        audio.play();
                        clearInterval(p);
                    ...
                    case 3: //preenche o segundo quadrado - 1cm²
                        ...
                        prencherquad++;
                        audio.src = "/Versao3.0/Audios/Fala 4.m4a";
                        audio.play();
                        mensagemAux = "";
                        contadorTexto = 0;
        ...
        case 2:
            {
                switch (prencherquad) {
                    ...
                    case 35: //executa o sexto áudio
                        audio.src = "/Versao3.0/Audios/Fala 6.m4a";
                        audio.play();
                        mensagemAux = "";
                        contadorTexto = 0;
        ...
        case 3:
            {
                switch (prencherquad) {
                    ...
                    case 8: //execução do áudio 10
                        audio.src = "/Versao3.0/Audios/Fala 10.m4a";
                        audio.play();
                        mensagemAux = "";
                        contadorTexto = 0;
            ...
            { //parte 1 da animacao--------------------------------------------------------------------------
                ...
                switch (etapa) {
                    case 1: //ativação do áudio 1
                        personagem.src = "/Versao3.0/Imagens/repouso.gif";
                    ...
                    case 2: //ativação do áudio 2
                        ...
                        audio.src = "/Versao3.0/Audios/Fala 2.m4a";
        ...
        case 2:
            { // parte 2 da animação--------------------------------------------------------------------------
                ...
                switch (etapa) {
                    case 1:
                        personagem.src = "/Versao3.0/Imagens/repouso.gif";
                        audio.src = "/Versao3.0/Audios/Fala 5.m4a";
            ...
            { //---------------------------------------------------------------------- Parte 3 da Animação
                ...
                switch (etapa) {
                    case 1: //executa o sétimo áudio
                        personagem.src = "/Versao3.0/Imagens/duvida.gif";
                        audio.src = "/Versao3.0/Audios/Fala 7.m4a";
                        audio.play();
                        clearInterval(temp);
                        mensagemAux = "";
                        contadorTexto = 0;
                    ...
                    case 23: //desenha linha 4
                        ...
                        break;
                    case 24:
                        personagem.src = "/Versao3.0/Imagens/aponta.gif";
                        audio.src = "/Versao3.0/Audios/Fala 8.m4a";
                        audio.play();
                        mensagemAux = "";
                        contadorTexto = 0;
                    ...
                    case 25:
                        personagem.src = "/Versao3.0/Imagens/repouso.gif";
                        audio.src = "/Versao3.0/Audios/Fala 9.m4a";
                        audio.play();
                        mensagemAux = "";
                        contadorTexto = 0;
